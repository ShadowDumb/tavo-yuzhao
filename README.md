...
基线 **473 项全绿**，覆盖协议解析、diff 合并、评估矩阵、预算窗口、世界书归档、版本迁移、备份恢复链、检索筛选、双玉兆传讯通道等。

### 发布门禁

1. `node tests/smoke.mjs` 473 项全绿
...
- 未发布源码已含：交互基座第一层（检索筛选）与双玉兆一期（玩家域 + 传讯通道），冒烟 **473 项全绿**；正式发布时按发布门禁出包并更新版本号
